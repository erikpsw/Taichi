...
def render():
    ...
    #ceil
    add_rect(ti.Vector([canvas_width/2,canvas_height,wall_distance/2]),DOWN,wall_distance,canvas_width,RIGHT,ti.Vector([0.8, 0.8, 0.8]))
    #ground
    add_rect(ti.Vector([canvas_width/2,0,wall_distance/2]),DOWN,wall_distance,canvas_width,RIGHT,ti.Vector([0.8, 0.8, 0.8]))
    #back wall

...
@ti.kernel
def rect_render(rect_pos,rect_normal,rect_width,rect_height,i_hat):
    for i,j in canvas:
        ...
        i_hat=i_hat.normalized()#指定宽的方向向量
...
while gui.running:
    #左壁
    rect_render(ti.Vector([0.,canvas_height/2,wall_distance/2]),LEFT,wall_distance,canvas_height,FRONT)
    # cnt += 1

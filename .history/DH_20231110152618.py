...
N=len(p_list)
line_points=ti.Vector.field(3,dtype=ti.f32,shape=N)
line_points.from_numpy(np.array(p_list))
...
while window.running:
    ...
    scene.lines(line_points, color = (0.28, 0.68, 0.99),indices=[range(N-1),range(1,N)], width = 5.0)
    # path.append(n2.pos)

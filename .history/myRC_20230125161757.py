...
def build_sence():
    ...
    Hierarchy.append(rect(ti.Vector([canvas_width/2,canvas_height+1,wall_distance/2]),DOWN,canvas_width,wall_distance,RIGHT,ti.Vector([0.8, 0.8, 0.8]),False,0)) 

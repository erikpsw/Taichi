...
# 定义颜色的参数
color_r = ti.Vector.field(dt=ti.f32, shape=num_columns)
color_g = ti.Vector.field(dt=ti.f32, shape=num_columns)
color_b = ti.Vector.field(dt=ti.f32, shape=num_columns)

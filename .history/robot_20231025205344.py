...
class Node:
    ...
    def get_angle(self):
        print(abs(self.exp_ax.imag))
        return atan(abs(self.exp_ax.imag)/self.exp_ax.real)
...
window_height = 600
n2=Node(2,0,0)
root=Node(0,45,0.7,children=[Node(1,45,0.6,children=[Node(5,45,0.5,[n2])])])
root.add_parents()
p_list=n2.get_pos()
# print(p_list[0])
gui = ti.GUI("robot", res=(window_width, window_height))
path=[n2.pos,n2.pos]
print(root.get_angle())
# while gui.running:
#     root.abs_theta+=0.02

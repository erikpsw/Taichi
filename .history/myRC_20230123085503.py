...
@ti.func
def rect_render(rect_pos,rect_normal,rect_width,rect_height,i_hat,color):
    for i,j in canvas:
...
while gui.running:
    #左壁
    rect_render(ti.Vector([0.,canvas_height/2,wall_distance/2]),LEFT,wall_distance,canvas_width,canvas_height,ti.Vector([0.0, 0.6, 0.0]))
    # cnt += 1
